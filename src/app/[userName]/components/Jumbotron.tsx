...
const ProfilePageJumbotron = () => {
  return (
    <div className=" pb-40">
      <div className=" h-[500px] relative" style={{ background: `url('images/ProfileBg1.png')` }}>
        <div className=" h-12 w-12 rounded-lg bg-white flex items-center justify-center absolute right-20 top-20"></div>
        <div className="absolute right-20 bottom-0 transform  translate-y-1/2 bg-white max-w-[1112px] min-h-80 rounded-lg w-full flex overflow-hidden gap-14 shadow-xl">
          <Image src={""} height={320} width={280} alt="profile picture" className=" bg-gray-200 rounded-lg" />
          <div className=" py-10 pr-10 flex-grow relative">
            <div className="">
              <div className=" flex justify-between">
                <div className="">
                  <p className=" text-tib-purple  text-2xl font-bold">Don Yep</p>
                  <p className=" text-tib-primary2">Arts</p>
                </div>
                {/* <FollowButton /> */}
              ...
              <p className="text-sm text-tib-primary2 mt-5">Kastroud</p>
              <p className=" w-[400px] mt-3 text-tib-primary">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fames aliquet viverra suspendisse sagittis pharetra rhoncus eget nullam
                aliquet. Curabitur sem et id ornare sit leo enim confames.
              </p>
              <div className=" flex gap-10 mt-5">
                ...
                <div className=" flex flex-col gap-1">
                  ...
                  <span className="text-tib-purple text-2xl">100</span>
                  <span className="text-sm">Followers</span>
                </div>
                <div className=" flex flex-col gap-1">
                  <BiSolidUser size={10} className=" text-tib-purple" />
                  <span className="text-tib-purple text-2xl">1K</span>
