        ...
        <div className=" relative pr-10">
          ...
          <div className=" flex  items-start justify-between">
            ...
            <div className=" flex gap-3  pt-8">
              <button className=" py-2 px-3 rounded border bg-tib-blue text-white text-sm">Accept</button>
              <button className=" py-2 px-3 rounded border border-tib-blue text-tib-blue text-sm">Ignore</button>
            </div>
          </div>
          {isHovered && (
