...
const Avatar: React.FC<{ user?: IUser; size?: "xs" | "sm" | "md" | "lg" | "xl" | "xxl" }> = (props) => {
  ...
  const height = size == "xs" ? "32px" : size == "sm" ? "48px" : size == "lg" ? "64px" : size == "xl" ? "100px" : size == "xxl" ? "152px" : "52px";
  const width = size == "xs" ? "32px" : size == "sm" ? "48px" : size == "lg" ? "64px" : size == "xl" ? "100px" : size == "xxl" ? "152px" : "52px";
